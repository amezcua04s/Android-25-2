 ...
 */
val amezcua = PostAuthor("Amezcua", "https://instagram/amezcua04s/")
...
val paragraphsPostAmezcua = listOf(
    Paragraph(
        ParagraphType.Text,
        "Mi primer página con Jetpack compose"
    ),
    Paragraph(
      ParagraphType.Text,
        "Para crear la primer página hice lo siguiente:\n" +
        "\tEn el archivo de [PostData.kt]:\n" +
        "\t\tCree una variable con el nombre del autor"
    ),
    Paragraph(
    ...
    Paragraph(
        ParagraphType.Text,
        "Después cree una variable de tipo post que serviría para mostrar todo en pantalla:\n"
    ),
    Paragraph(
        ParagraphType.CodeBlock,
        "val postAmezcua = Post(\n" +
                "    id = \"dc513a0e425c\",\n" +
                "    title = \"Amezcua Arévalo Santiago\",\n" +
                "    subtitle = \"Como crear tu propio post utilizando Compose\",\n" +
                ...
                "    imageId = R.drawable.hola,\n" +
                "    imageThumbId = R.drawable.hola\n" +
                ")"
    ),
    Paragraph(
        ParagraphType.Caption,
        "Aunque en esta parte tuve que crear un drawable y asignar un id random de valores hexadecimales."
    ),
    Paragraph(
        ParagraphType.Text,
        "Y por último con el uso de Paragraph, ParagraphType, ingrese todos los elementos de esta pantalla"
    )
)
...
val postAmezcua = Post(
    ...
    paragraphs = paragraphsPostAmezcua,
    imageId = R.drawable.hola,
    imageThumbId = R.drawable.hola
)
...
val posts: PostsFeed =
    PostsFeed(
        ...
        recommendedPosts = listOf(postAmezcua, post1, post2, post3),
        popularPosts = listOf(
            post5,
            post1.copy(id = "post6"),
            post2.copy(id = "post7")
